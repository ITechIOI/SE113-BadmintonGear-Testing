...
export default function Sidebar() {
    ...
    return (
        <aside className="w-fit bg-white h-screen p-5">
            <div className="flex items-center gap-2 mb-10 cursor-pointer" id="logo" onClick={() => window.location.href = "/admin/dashboard"}>
            ...
            <nav className="flex flex-col gap-4 text-lg font-[500]">
                <a
                    ...
                    className={`flex gap-2 py-2 px-2 ${pathname === "/admin/dashboard" ? "bg-[#ff8200] rounded-md text-white" : "text-gray-600"
                    ...
                    {isProductDropdownOpen && (
                        <div className="ml-6 mt-2 flex flex-col gap-2">
                            <a
                                ...
                                className={`py-2 ${pathname === "/admin/product/list" ? "bg-[#ff8200] rounded-md text-white" : "text-gray-600"
                                    }`}
                            >
                                Product List
                            </a>
                            <a
                                ...
                                className={`py-2 ${pathname === "/admin/product/categories" ? "bg-[#ff8200] rounded-md text-white" : "text-gray-600"
                                    }`}
                            >
                                Categories
                            </a>
                ...
                <a
                    href="/admin/order"
                    className={`flex gap-2 py-2 px-2 ${pathname === "/admin/order" ? "text-blue-600 font-bold" : "text-gray-600"
                        } hover:bg-[#ff8200] hover:text-white transition duration-300 rounded-md`}
                >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a
                    href="/admin/customer"
                    className={`flex gap-2 py-2 px-2 ${pathname === "/admin/customer" ? "text-blue-600 font-bold" : "text-gray-600"
                        } hover:bg-[#ff8200] hover:text-white transition duration-300 rounded-md`}
                >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
