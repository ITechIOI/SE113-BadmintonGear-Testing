...
export default function AddressPage() {
    const [address, setAddress] = useState([
        { id: "1", name: "John Doe", address: "123 Main St", phone: "123-456-7890", email: "user@gmail.com" },
        { id: "2", name: "Jane Smith", address: "456 Elm St", phone: "987-654-3210", email: "user#gmail.com" },
            ...
            <div className='mx-20 grid grid-cols-[20%_1fr] gap-5 mt-10'>
                <div className='flex flex-col gap-3 font-medium' >
                    ...
                    <div className='text-gray-500 font-normal ml-3 flex flex-col gap-2'>
                        ...
                        <a href='address' className='text-[#ff8200]'>Address Book</a>
                    </div>
                ...
                <div className='w-full bg-white pb-10'>
                    <p className='text-[#ff8200] text-xl mt-10 w-4/5 mx-auto'>Address Book</p>
                    ...
                    <div className='flex justify-end gap-5 items-center mt-5 mr-5'>
                        ...
                        <button className='bg-[#ff8200] text-white px-4 py-2 rounded-xs'>Add New Address</button>
                    </div>
                </div>
            </div>
        </div>
