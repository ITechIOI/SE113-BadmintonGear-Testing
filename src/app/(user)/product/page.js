  ...
  return (
    <div className="max-w-[1800px] mx-auto">
      <div id="roadmap" className="flex items-center mt-10 ml-15">
        ...
        <label className="ml-3 mr-3">/</label>
        <a className="text-black" href={`/product/${product.id}`}>
          {product.name || ""}
        </a>
      </div>
      <div className="mx-auto mt-10">
          ...
          <div>
            <div className="w-full flex flex-col gap-5 border-b border-gray-500 pb-5 h-fit">
                ...
                <div className="flex items-center text-xl">
                  {Array.from({ length: 5 }, (_, index) => (
                    <span
                      key={index}
                      className={
                        index < ratings ? "text-[#FFAD33]" : "text-gray-300"
                      }
                    >
                      ★
                    </span>
                  ))}
                  <div className="text-black opacity-50 ml-4">
                    ({ratingCount} reviews)
                  </div>
                </div>
              ...
              <div className="flex items-center mt-2">
                ...
                {product.discount > 0 && (
                  <p className="ml-5 text-black opacity-50 text-lg line-through">
                    ${product.price}
                  </p>
                )}
              </div>
            ...
            <div className="flex gap-5 items-center mt-5">
              ...
              <button
                className="bg-white text-[#FF8200] border border-[#FF8200] rounded-xs px-4 py-2"
                onClick={handleAddToCart}
              >
                Add To Cart
              </button>
              <button className="bg-[#FF8200] text-white rounded-xs px-4 py-2">
                Buy Now
              </button>
        ...
        <div className="h-fit  border-b border-gray-500 pb-5">
          <div className="flex items-center justify-center mx-40 gap-20 text-lg">
            ...
            <p
              className={reviewsVisible ? "font-semibold" : ""}
