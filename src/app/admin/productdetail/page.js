...
import { getProductById, updateProduct, uploadImage, deleteImage } from '@/api/productApi';
...
export default function ProductDetail() {
    ...
    const isDisabledSave = () => {
        ...
        const categoryId = inputProduct.categoryId ?? selectedCategory ?? product.categoryId ?? 0;

        if (!name || !description || !price || !quantity || !categoryId) return true;

        const isImageChanged = imagePreviews && imagePreviews !== getLinkImage(product.imageUrl);
        ...
        if (
            ...
            Number(categoryId) === Number(product.category?.id ?? product.categoryId ?? 0) &&
            !isImageChanged
        ) return true;
            ...
            <div className='flex justify-between items-end'>
                <div>
                    ...
                    <div id="roadmap" className="flex items-center mt-2">
                        ...
                        <a className="text-[#667085]" href="/admin/addproduct">Product Details</a>
                    </div>
                </div>
                {mode === 'view' && product && (
                    <div>
                    ...
                    <div className='bg-white shadow-md rounded-lg p-5 mt-5'>
                        ...
                        <div className='mt-2 gap-1'>
                            ...
                            <div className='border border-[#E0E2E7] bg-[#F9F9FC] rounded-md w-full px-3 py-2 flex items-center gap-2'>
                                ...
                                <input id='price' type="number" className='w-full outline-none'
