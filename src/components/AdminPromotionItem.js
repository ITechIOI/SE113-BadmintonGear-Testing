...
export default function AdminPromotionItem({ promotion, onCheck, onDelete }) {
  ...
  return (
    <tr className="bg-white shadow-md border-b border-[#F0F1F3]">
      ...
      <td className="text-[#ff8200]">{promotion.description}</td>
        ...
        <div
          className={`w-fit px-2 py-1 rounded-full ${
            promotion.status === "available"
              ...
              : promotion.status === "Out of turn"
              ? "text-[#E46A11] bg-[#FDF1E8]"
      ...
      <td>
        <div className="flex  items-center gap-3 py-4 justify-center">
          <button
            onClick={() =>
              router.push(
                "/admin/promotiondetail?id=" + promotion.id + "&mode=view"
              )
            }
          >
            <svg
          ...
          <button
            onClick={() =>
              router.push(
                "/admin/promotiondetail?id=" + promotion.id + "&mode=edit"
              )
            }
          >
            <svg
