    ...
    return (
        <aside className="w-7/30 bg-white  p-5">
            ...
            <nav className="flex flex-col gap-4 text-lg font-[500]">
                ...
                <a
                    href="/admin/order"
                    className={`flex gap-2 py-2 px-2 ${pathname === "/admin/order" ? "bg-[#ff8200] rounded-md text-white" : "text-gray-600"
                        } hover:bg-[#ff8200] hover:text-white transition duration-300 rounded-md`}
                >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a
                    href="/admin/customer"
                    className={`flex gap-2 py-2 px-2 ${pathname === "/admin/customer" ? "bg-[#ff8200] rounded-md text-white" : "text-gray-600"
                        } hover:bg-[#ff8200] hover:text-white transition duration-300 rounded-md`}
                >
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
