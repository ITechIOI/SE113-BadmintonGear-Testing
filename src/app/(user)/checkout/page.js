...
export default function CheckOut() {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      ...
      console.log("Discount find: ", discountData);

      const parsedDiscount = discountData ? JSON.parse(discountData) : null;
      setDiscount(parsedDiscount);
      setPromotion(parsedDiscount.percent || 0);
      setSubtotal(
        parsedItems.reduce((acc, item) => acc + (item.subtotal || 0), 0)
      );
    }
  }, []);
  ...
  return (
    <div className="max-w-[1800px] mx-auto">
      ...
      <div className="mx-20 mt-5">
        ...
        <div className="grid grid-col lg:grid-cols-2 gap-5 mt-5">
          <div>
            ...
            <div className="flex w-full">
              ...
              />
              <button
                className="bg-[#FF8200] text-white rounded-xs px-10 py-3 ml-5"
          ...
          <div className="px-10">
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 mb-1">
                Address <span className="text-[#ff8200]">*</span>
              </label>
              <input
                type="text"
                id="address"
            ...
            <div className="flex flex-col">
              <label className="text-xs text-gray-500 mb-1">
                Phone Number <span className="text-[#ff8200]">*</span>
              </label>
              <input
                type="text"
                id="phone"
        ...
        <button
          className="bg-[#FF8200] text-white rounded-xs px-10 py-3 mt-5"
