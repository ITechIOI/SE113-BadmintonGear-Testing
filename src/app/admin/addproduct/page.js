            ...
            <div className='mt-5 flex justify-between '>
                <div className='w-2/3 '>
                    ...
                    <div className='bg-white shadow-md rounded-lg p-5 mt-5'>
                        ...
                        <div
                            className={`flex flex-col gap-3 justify-center items-center py-4 ${isDragging ? "border-dashed border-[#ff8200]" : "border-[#E0E2E7]"
                                }`}
                                ...
                                {imagePreviews.map((preview, index) => (
                                    <div key={index} className="relative">
                                        <Image
                                            ...
                                            width={200}
                                            height={200}
                                            className="w-full h-auto rounded-md border border-[#E0E2E7]"
                                        />
                                        <button
