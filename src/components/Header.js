                ...
                <div>
                    <nav>
                        <ul className="flex gap-4 text-lg font-montserrat font-bold text-[#737373] ml-auto" id="nav">
                            ...
                            <li><a className="hover:text-[#252B42]" href="/productlist">Product</a></li>
