...
import { addProduct, uploadImage } from '@/api/productApi';
...
export default function AddProduct() {
    ...
    const handleImageUpload = (event) => {
        ...
        reader.onload = () => {
            setImagePreviews(reader.result); // Thay thế ảnh cũ bằng ảnh mới
        };
    ...
    const handleSave = async () => {
        ...
        if (file) {
            ...
            if (uploadResponse) {
                productData.append('imageUrl', uploadResponse);
            } 
            else {
        ...
        productData.append('brand', inputData.brand);
            ...
            <div className='flex justify-between items-end'>
                ...
                <div className='flex gap-3'>
                    <button className='border border-[#858D9D] text-[#858D9D] px-4 py-2 rounded-md flex gap-2 items-center'
                        ...
                        Cancel</button>
                    <button className='bg-[#ff8200] text-white px-4 py-2 rounded-md flex gap-2 items-center disabled:opacity-50 disabled:cursor-not-allowed'
                        onClick={handleSave}
                        disabled={!inputData || !inputData.name || !inputData.description || !inputData.price || !inputData.quantity || !inputData.categoryId || !imagePreviews}>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className='w-2/3 '>
                    <div className='bg-white shadow-md rounded-lg p-5'>
                        ...
                        <div className='mt-2 gap-1'>
                            ...
                            <input id='brand' type="text" className='border border-[#E0E2E7] bg-[#F9F9FC] rounded-md w-full px-3 py-2  outline-none'
                                placeholder='Type product brand here...' onChange={hadleInputChange} />
                        </div>
                    </div>
                    ...
                    <div className='bg-white shadow-md rounded-lg p-5 mt-5'>
                        ...
                        <div
                            ...
                            onDrop={handleDrop}
                        >
                            {!imagePreviews && (<div className='rounded-full p-2 bg-[#FBE3CA] border-3 border-[#EFEFFD] w-fit'>
