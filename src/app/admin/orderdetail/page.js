      ...
      <div className="flex justify-between items-end">
        <div>
          ...
          <div id="roadmap" className="flex items-center mt-2">
            ...
            <a className="text-[#ff8200]" href="/admin/order">
              Order List
            </a>
            <label className="ml-3 mr-3">
              <svg
            ...
            <a className="text-[#667085]" href="/admin/orderdetail">
              Order Detail
            </a>
          </div>
        </div>
        <div className="flex gap-2">
          <div className="rounded-md bg-white border border-[#E0E2E7] px-4 py-2 flex items-center gap-2">
            <select
              ...
              name="status"
              id="status"
              defaultValue={order ? order.status : "pending"}
          ...
          <button className="flex gap-2 bg-[#ff8200] text-white px-4 py-2 rounded-md">
            ...
            >
              <path
                d="M4.99935 13.3333C4.99935 12.8731 5.37245 12.5 5.83268 12.5H7.49935C7.95959 12.5 8.33268 12.8731 8.33268 13.3333C8.33268 13.7936 7.95959 14.1667 7.49935 14.1667H5.83268C5.37245 14.1667 4.99935 13.7936 4.99935 13.3333Z"
                fill="white"
              />
              <path
                d="M5.83268 9.16667C5.37245 9.16667 4.99935 9.53976 4.99935 10C4.99935 10.4602 5.37245 10.8333 5.83268 10.8333H10.8327C11.2929 10.8333 11.666 10.4602 11.666 10C11.666 9.53976 11.2929 9.16667 10.8327 9.16667H5.83268Z"
                fill="white"
              />
              <path
                d="M4.99935 6.66667C4.99935 6.20643 5.37245 5.83333 5.83268 5.83333H10.8327C11.2929 5.83333 11.666 6.20643 11.666 6.66667C11.666 7.1269 11.2929 7.5 10.8327 7.5H5.83268C5.37245 7.5 4.99935 7.1269 4.99935 6.66667Z"
                fill="white"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M1.66602 5.83333C1.66602 3.99238 3.1584 2.5 4.99935 2.5H11.666C13.507 2.5 14.9993 3.99238 14.9993 5.83333V8.33333H15.8327C17.2134 8.33333 18.3327 9.45262 18.3327 10.8333V15C18.3327 16.3807 17.2134 17.5 15.8327 17.5H4.99935C3.1584 17.5 1.66602 16.0076 1.66602 14.1667V5.83333ZM15.8327 15.8333C16.2929 15.8333 16.666 15.4602 16.666 15V10.8333C16.666 10.3731 16.2929 10 15.8327 10H14.9993V15C14.9993 15.4602 15.3724 15.8333 15.8327 15.8333ZM13.3327 15C13.3327 15.2922 13.3828 15.5727 13.4749 15.8333H4.99935C4.07887 15.8333 3.33268 15.0871 3.33268 14.1667V5.83333C3.33268 4.91286 4.07887 4.16667 4.99935 4.16667H11.666C12.5865 4.16667 13.3327 4.91286 13.3327 5.83333V15Z"
                fill="white"
              />
            </svg>
            Invoice
          ...
          <div className="flex justify-between items-center mt-2">
            <div className="flex gap-2 items-center">
              ...
              >
                ...
                />
                <path
                  d="M23.9666 20.6975C24.3519 20.3017 24.3433 19.6686 23.9475 19.2834C23.5517 18.8982 22.9186 18.9068 22.5334 19.3025L19.2737 22.6517L17.8755 21.5309C17.4446 21.1854 16.8152 21.2547 16.4698 21.6856C16.1244 22.1166 16.1936 22.7459 16.6246 23.0914L19.0857 25.0643C19.2867 25.2254 19.5771 25.2075 19.7567 25.0229L23.9666 20.6975Z"
                  fill="#667085"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M16 10C16.5523 10 17 10.4477 17 11H23C23 10.4477 23.4477 10 24 10C24.5523 10 25 10.4477 25 11H26C27.6569 11 29 12.3431 29 14V27C29 28.6569 27.6569 30 26 30H14C12.3431 30 11 28.6569 11 27V14C11 12.3431 12.3431 11 14 11H15C15 10.4477 15.4477 10 16 10ZM27 14V15H13V14C13 13.4477 13.4477 13 14 13H15C15 13.5523 15.4477 14 16 14C16.5523 14 17 13.5523 17 13H23C23 13.5523 23.4477 14 24 14C24.5523 14 25 13.5523 25 13H26C26.5523 13 27 13.4477 27 14ZM13 27V17H27V27C27 27.5523 26.5523 28 26 28H14C13.4477 28 13 27.5523 13 27Z"
                  fill="#667085"
                />
              </svg>
              Added
          ...
          <div className="flex justify-between items-center mt-2">
            <div className="flex gap-2 items-center">
              ...
              >
                ...
                />
                <path
                  d="M18.5 25C17.9477 25 17.5 25.4477 17.5 26C17.5 26.5523 17.9477 27 18.5 27H21.5C22.0523 27 22.5 26.5523 22.5 26C22.5 25.4477 22.0523 25 21.5 25H18.5Z"
                  fill="#667085"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M13.5 13C13.5 11.3431 14.8431 10 16.5 10H23.5C25.1569 10 26.5 11.3431 26.5 13V27C26.5 28.6569 25.1569 30 23.5 30H16.5C14.8431 30 13.5 28.6569 13.5 27V13ZM16.5 12H23.5C24.0523 12 24.5 12.4477 24.5 13V27C24.5 27.5523 24.0523 28 23.5 28H16.5C15.9477 28 15.5 27.5523 15.5 27V13C15.5 12.4477 15.9477 12 16.5 12Z"
                  fill="#667085"
                />
              </svg>
              Phone
      ...
      <div className="flex gap-[7%] w-full mt-5">
        <div className="w-9/14 p-5 bg-white rounded-md shadow-md h-fit">
          <div className="flex w-full gap-4 items-center px-5">
            ...
            <div className="bg-[#E7F4EE] text-[#0D894F] rounded-full px-2 py-1">
              {details.length} Product{details.length < 2 ? "" : "s"}
            </div>
          </div>
            ...
            <tbody className="text-[#344054] font-normal text-center">
              ...
              {order && order.discount && (
                <tr>
                  ...
                  <td className="py-2 px-4 ">
                    -{Number(order.discount.percent).toLocaleString()} %
                  </td>
                </tr>
              )}
              <tr>
                ...
                <td className="py-2 px-4 font-semibold">
                  {order ? Number(order.totalPrice).toLocaleString() : 0} $
                </td>
              </tr>
            </tbody>
          </table>
          ...
          <div className="p-5 bg-white rounded-md shadow-md w-full mt-5 flex flex-col gap-5">
            ...
            <div className="flex gap-2 items-center">
              ...
              >
                ...
                />
                <path
                  d="M14.638 12.1223C14.4569 11.1806 13.6329 10.5 12.674 10.5H11C10.4477 10.5 10 10.9477 10 11.5C10 12.0523 10.4477 12.5 11 12.5L12.674 12.5L14.55 22.2554C14.9122 24.1388 16.5602 25.5 18.478 25.5H24.6873C26.5044 25.5 28.0932 24.2752 28.5556 22.518L29.8068 17.7635C30.3074 15.8612 28.8726 14 26.9056 14H25.5C24.9477 14 24.5 14.4477 24.5 15C24.5 15.5523 24.9477 16 25.5 16H26.9056C27.5613 16 28.0395 16.6204 27.8727 17.2545L26.6215 22.009C26.3903 22.8876 25.5959 23.5 24.6873 23.5H18.478C17.5191 23.5 16.6951 22.8194 16.514 21.8777L15.3837 16H18C18.5523 16 19 15.5523 19 15C19 14.4477 18.5523 14 18 14H14.9991L14.638 12.1223Z"
                  fill="#FF8200"
                />
                <path
                  d="M16.75 29.5C15.9216 29.5 15.25 28.8284 15.25 28C15.25 27.1716 15.9216 26.5 16.75 26.5C17.5784 26.5 18.25 27.1716 18.25 28C18.25 28.8284 17.5784 29.5 16.75 29.5Z"
                  fill="#FF8200"
                />
                <path
                  d="M25.5 29.5C24.6716 29.5 24 28.8284 24 28C24 27.1716 24.6716 26.5 25.5 26.5C26.3284 26.5 27 27.1716 27 28C27 28.8284 26.3284 29.5 25.5 29.5Z"
                  fill="#FF8200"
                />
                <path
                  d="M18.0429 17.7929C18.4334 17.4024 19.0666 17.4024 19.4571 17.7929L20.75 19.0858V12C20.75 11.4477 21.1977 11 21.75 11C22.3023 11 22.75 11.4477 22.75 12V19.0858L24.0429 17.7929C24.4334 17.4024 25.0666 17.4024 25.4571 17.7929C25.8476 18.1834 25.8476 18.8166 25.4571 19.2071L22.1036 22.5607C21.9083 22.7559 21.5917 22.7559 21.3964 22.5607L18.0429 19.2071C17.6524 18.8166 17.6524 18.1834 18.0429 17.7929Z"
                  fill="#FF8200"
                />
              </svg>
              <div>
            ...
            <div className="flex gap-2 items-center">
              ...
              >
                <rect
                  ...
                  height="36"
                  rx="18"
                  fill={order.status === "pending" ? "#FBE3CA" : "#E0E2E7"}
                />
                <rect
                  x="2"
                  y="2"
                  ...
                  height="36"
                  rx="18"
                  stroke={order.status === "pending" ? "#EFEFFD" : "#F0F1F3"}
                  strokeWidth="4"
                />
                <path
                  d="M13.9359 16.5007C15.1477 14.4058 17.4103 13 20 13C23.5525 13 26.4869 15.6463 26.9395 19.0752L26.2071 18.3429C25.8166 17.9523 25.1834 17.9523 24.7929 18.3429C24.4024 18.7334 24.4024 19.3665 24.7929 19.7571L27.6464 22.6106C27.8417 22.8059 28.1583 22.8059 28.3536 22.6106L31.2071 19.7571C31.5976 19.3665 31.5976 18.7334 31.2071 18.3429C30.8166 17.9523 30.1834 17.9523 29.7929 18.3429L28.9625 19.1732C28.5451 14.5902 24.6918 11 20 11C16.6675 11 13.7593 12.8118 12.2047 15.4993C11.9281 15.9773 12.0915 16.5891 12.5695 16.8656C13.0476 17.1421 13.6593 16.9788 13.9359 16.5007Z"
                  fill={order.status === "pending" ? "#FF8200" : "#667085"}
                />
                <path
                  d="M13.7929 22.2571C14.1834 22.6476 14.8166 22.6476 15.2071 22.2571C15.5976 21.8666 15.5976 21.2334 15.2071 20.8429L12.3536 17.9894C12.1583 17.7941 11.8417 17.7941 11.6464 17.9894L8.79289 20.8429C8.40237 21.2334 8.40237 21.8666 8.79289 22.2571C9.18342 22.6476 9.81658 22.6476 10.2071 22.2571L11.1024 21.3619C11.7588 25.6862 15.4924 29 20 29C22.8426 29 25.3779 27.681 27.0256 25.6255C27.3711 25.1946 27.3018 24.5652 26.8708 24.2198C26.4399 23.8743 25.8106 23.9436 25.4651 24.3745C24.1806 25.9769 22.2101 27 20 27C16.707 27 13.9451 24.7262 13.1987 21.663L13.7929 22.2571Z"
                  fill={order.status === "pending" ? "#FF8200" : "#667085"}
                />
              </svg>
              <div>
                ...
                <div className="text-gray-500 text-sm">
                  {order.processTime ? order.processTime : "yyyy-MM-dd"}
                </div>
              </div>
            </div>
            <div className="flex gap-2 items-center">
              ...
              >
                <rect
                  ...
                  height="36"
                  rx="18"
                  fill={order.status === "Shipping" ? "#FBE3CA" : "#E0E2E7"}
                />
                <rect
                  x="2"
                  y="2"
              ...
              <div>
                ...
                <div className="text-gray-500 text-sm">
                  {order.shippingTime ? order.shippingTime : "yyyy-MM-dd"}
                </div>
              </div>
            </div>
            <div className="flex gap-2 items-center">
              ...
              >
                <rect
                  ...
                  height="36"
                  rx="18"
                  fill={order.status === "Delivered" ? "#FBE3CA" : "#E0E2E7"}
                />
                <rect
                  x="2"
                  y="2"
                  ...
                  height="36"
                  rx="18"
                  stroke={order.status === "Delivered" ? "#EFEFFD" : "#F0F1F3"}
                  strokeWidth="4"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M27.1364 13.7287C27.5624 14.0801 27.6229 14.7104 27.2714 15.1364L18.6925 25.5351C18.5126 25.7531 18.1879 25.7788 17.976 25.5918L13.3384 21.4999C12.9243 21.1345 12.8848 20.5025 13.2502 20.0884C13.6156 19.6743 14.2475 19.6348 14.6616 20.0002L18.1365 23.0662L25.7286 13.8636C26.0801 13.4376 26.7104 13.3772 27.1364 13.7287Z"
                  fill={order.status === "Delivered" ? "#FF8200" : "#667085"}
                />
              </svg>
              ...
              <div>
                ...
                <div className="text-gray-500 text-sm">
                  {order.deliverTime ? order.deliverTime : "yyyy-MM-dd"}
                </div>
              </div>
            </div>
          </div>
