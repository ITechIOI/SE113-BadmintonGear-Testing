...
import { updateUser, getProfile, uploadImage, deleteImage } from '@/api/userApi';
        ...
        <div className='px-2 py-5'>
            <div>
                ...
                <div id="roadmap" className="flex items-center mt-2">
                    ...
                    <a className="text-[#667085]" href="/admin/account">Account</a>
                </div>
            </div>
                ...
                <div className='flex flex-col gap-3 font-medium' >
                    <div className="max-w-sm mx-auto bg-white rounded-xl shadow-md overflow-hidden w-full p-1">
                        ...
                        <div className="flex flex-col gap-3 items-center -mt-20">
                            <div>
                                <Image
                                    src={avatarPreview || (user && user.avatar && getAvatarLink(user.avatar)) || "/images/noavatar.png"}
                                    alt="user"
                                    width={150}
                                    height={150}
                            ...
                            {imageMenu && (
                                <div ref={menuRef} className="absolute bg-white shadow-lg rounded-md p-2 mt-2">
                            ...
                            <p className="text-lg text-gray-500">{user ? user.username : ""}</p>
                            <p className="text-md text-gray-500">{user ? user.roles : ""}</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='mt-10 mx-auto w-4/5'>
                        ...
                        <div className='flex w-full gap-5 mt-5 justify-between'>
                            ...
                            <div className='flex flex-col gap-1 w-3/7'>
                                ...
                                <input id='phonenumber' type="text" className='bg-gray-100 rounded-xs p-2' defaultValue={user ? user.phone : ""} onChange={checkValidInput} />
                            </div>
                        </div>
