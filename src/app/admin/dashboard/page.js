...
export default function DashboardPage() {
  ...
  const handleSelectAll = () => {
    ...
    setOrders(
      orders.map((order) => ({ ...order, isChecked: newCheckedState }))
    );
  };
        ...
        <div className="bg-white rounded-md shadow-md p-5 w-6/25">
          <div className="flex justify-between items-center rounded-full bg-[#FDF1E8] p-1 w-fit">
            <div className="flex items-center justify-center rounded-full bg-[#FAE1CF] p-2">
              ...
              >
                <path
                  d="M13 9.5C12.4477 9.5 12 9.94771 12 10.5C12 11.0523 12.4477 11.5 13 11.5H15C15.5523 11.5 16 11.0523 16 10.5C16 9.94771 15.5523 9.5 15 9.5H13Z"
                  fill="#E46A11"
                />
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
                  d="M18 3.5C19.1046 3.5 20 4.39543 20 5.5V15C20 16.6569 18.6569 18 17 18H3C1.34315 18 0 16.6569 0 15V3C0 1.34315 1.34315 0 3 0H15C16.6569 0 18 1.34315 18 3V3.5ZM15 2H3C2.44772 2 2 2.44772 2 3V15C2 15.5523 2.44772 16 3 16H17C17.5523 16 18 15.5523 18 15V5.5H7C6.44772 5.5 6 5.05228 6 4.5C6 3.94772 6.44772 3.5 7 3.5H16V3C16 2.44772 15.5523 2 15 2Z"
                  fill="#E46A11"
                />
              </svg>
            </div>
