...
export default function OrderDetailPage(id) {
    ...
    const [details, setDetails] = useState([
        { id: "1", product: "Product 1", image: "/images/product1.png", price: 100, quantity: 1, discount: 10 },
        { id: "2", product: "Product 1", image: "/images/product1.png", price: 100, quantity: 2, discount: 10 },
        ...
        <div>
            ...
            <div className='mx-20 grid grid-cols-[20%_1fr] gap-5 mt-10'>
                ...
                <div className='w-full bg-white pb-10'>
                    <div className='flex justify-between w-4/5 mx-auto mt-10'
                        onClick={() => window.history.back()}>
                        <div className='flex gap-3 w-1/2 items-center'>
                            <Image src={"/icons/backic.png"} alt="back" width={10} height={15} className='cursor-pointer object-contain' />
                            <p className='text-xl w-4/5 '>Back</p>
                        </div>
                        <div>ID: {order?order.id:""} | <span className={order.state === "On Delivery" ? "text-[#ff8200]"
                            : (order.state === "Done" ? "text-[#08AC45]" : "text-[#EA4335]")} >
                            {order.state}</span></div>
                    </div>
