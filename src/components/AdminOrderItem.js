            ...
            {button && (
                <td>
                    <div className='flex justify-center items-center gap-3'>
                        <button onClick={() => { window.location.href = `/admin/orderdetail?id=${order.id}&mode=view` }}>
                        ...
                        <button onClick={() => { window.location.href = `/admin/orderdetail?id=${order.id}&mode=edit` }}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
