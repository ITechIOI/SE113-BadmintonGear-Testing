...
export default function CancellationOrderPage() {
    const [order, setOrder] = useState([
        ...
        { id: "2", total: 789, state: "Cancelled" },
        { id: "3", total: 234, state: "Cancelled" },
        { id: "4", total: 567, state: "Cancelled" },
    ]); // Khởi tạo state cho danh sách dơn hàng bị hủy
            ...
            <div className='mx-20 grid grid-cols-[20%_1fr] gap-5 mt-10'>
                <div className='flex flex-col gap-3 font-medium' >
                    ...
                    <div className='text-gray-500 font-normal ml-3 flex flex-col gap-2'>
                        ...
                        <a href='/cancellation' className='text-[#ff8200]'>My Cancellations</a>
                    </div>
                    <a href='/wishlist'>My WishList</a>
                    <a href='/promotion'>My Promotions</a>
                </div>
                <div className='w-full bg-white pb-10'>
                    <p className='text-[#ff8200] text-xl mt-10 w-4/5 mx-auto'>My Cancellations</p>
